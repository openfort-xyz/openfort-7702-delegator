...
const CONTRACT_ADDR  = "0x0000000000000000000000000000000000000000";

const SPEND_LIMIT    = utils.parseEther("0");
const ETH_LIMIT      = utils.parseEther("0");
const LIMIT          = 0;
...
const ALLOWED = ["0xdeadbeaf"];                 // approve(address,uint256)
